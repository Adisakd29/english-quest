...
const GRAMMAR_CHAPTERS = [
  ...
  },
  {
    ...
    intro: 'Tense คือการผันกริยาให้ตรงกับเวลา — มี 12 tenses แต่ที่ใช้บ่อยคือ Present, Past, Future แต่ละกลุ่มมี 4 ลักษณะ',
    sections: [
      {
        heading: 'โครงสร้าง 12 Tenses ภาพรวม',
        content: '12 Tense = <b>3 กลุ่มเวลา (Past, Present, Future) × 4 ลักษณะ (Simple, Continuous, Perfect, Perfect Continuous)</b><br><br>สูตรจำ:<br>• Simple = V.<br>• Continuous = <b>be + V.ing</b><br>• Perfect = <b>have + V.3</b><br>• Perfect Continuous = <b>have been + V.ing</b>',
        examples: [
          { en: 'Present Simple: I <b>go</b>', th: 'ปัจจุบันธรรมดา' },
          { en: 'Present Continuous: I <b>am going</b>', th: 'กำลัง...' },
          { en: 'Present Perfect: I <b>have gone</b>', th: '...แล้ว/เคย' },
          { en: 'Past Simple: I <b>went</b>', th: 'อดีตธรรมดา' },
          { en: 'Future Simple: I <b>will go</b>', th: 'จะไป' },
        ],
      },
      {
        heading: 'Present Simple (ปัจจุบันธรรมดา)',
        content: 'ใช้กับ:<br>• ความจริงเสมอ: The sun rises in the east.<br>• นิสัย/ทำเป็นประจำ: I drink coffee every morning.<br>• ตารางเวลา: The train leaves at 8 PM.<br><br>โครงสร้าง: <b>S + V.1(s/es)</b><br>คำบอก: always, often, usually, sometimes, every day/week',
        examples: [
          { en: 'I <b>drink</b> water every day.', th: 'นิสัย' },
          { en: 'She <b>works</b> in a bank.', th: 'V. เติม s (She)' },
          { en: 'Water <b>boils</b> at 100°C.', th: 'ความจริงเสมอ' },
        ],
        practice: [
          { prompt: '"She ___ to work every day." (นิสัย)', choices: ['go', 'goes', 'going', 'went'], correctIndex: 1, explain: 'Present Simple + She → goes' },
        ],
      },
      {
        heading: 'Present Continuous (กำลัง...)',
        content: 'ใช้กับ:<br>• กำลังเกิดขึ้นในขณะพูด: I <b>am eating</b> now.<br>• แผนในอนาคตอันใกล้ที่จัดไว้แล้ว: We <b>are meeting</b> tomorrow.<br><br>โครงสร้าง: <b>S + is/am/are + V.ing</b><br>คำบอก: now, right now, at the moment, currently<br><br>⚠️ กริยาบางตัวห้ามใช้ ing: know, love, understand, want, remember (State Verbs)',
        examples: [
          { en: 'I <b>am eating</b> now.', th: 'กำลังทำ' },
          { en: 'They <b>are playing</b> football.', th: 'กำลัง' },
          { en: 'I know (ห้าม: I am knowing)', th: 'know = state verb' },
        ],
        practice: [
          { prompt: '"I ___ TV now." (กำลัง)', choices: ['watch', 'watches', 'am watching', 'watched'], correctIndex: 2, explain: 'Present Continuous: am + V.ing' },
        ],
      },
      {
        heading: 'Present Perfect (...แล้ว/เคย)',
        content: 'ใช้กับ:<br>• เหตุการณ์ในอดีตที่มีผลถึงปัจจุบัน: I <b>have lost</b> my keys.<br>• ประสบการณ์: I <b>have been</b> to Japan.<br>• เพิ่งจบ: She <b>has just left</b>.<br><br>โครงสร้าง: <b>S + has/have + V.3</b><br>คำบอก: already, just, yet, ever, never, since, for, recently',
        examples: [
          { en: 'I <b>have finished</b> my work.', th: 'ทำเสร็จแล้ว (มีผลตอนนี้)' },
          { en: 'She <b>has been</b> to Japan twice.', th: 'ประสบการณ์' },
          { en: 'I <b>have lived</b> here <b>for</b> 5 years.', th: 'อาศัยมา 5 ปี ยังอยู่' },
        ],
        practice: [
          { prompt: '"I ___ already ___ my homework."', choices: ['have / finish', 'have / finished', 'has / finished', 'am / finishing'], correctIndex: 1, explain: 'already + Perfect → have + V.3' },
        ],
      },
      {
        heading: 'Past Simple (อดีตธรรมดา)',
        content: 'ใช้กับเหตุการณ์ที่เกิดและ<b>จบไปแล้ว</b>ในอดีต<br><br>โครงสร้าง: <b>S + V.2</b><br>คำบอก: yesterday, last week/month/year, ago, in 1990<br><br>Verb 2 มี 2 แบบ:<br>• Regular: เติม -ed (play → played)<br>• Irregular: ต้องจำ (go → went, eat → ate)',
        examples: [
          { en: 'I <b>went</b> to school yesterday.', th: 'อดีตจบแล้ว' },
          { en: 'She <b>ate</b> lunch at noon.', th: 'eat → ate (irregular)' },
          { en: 'They <b>played</b> football.', th: 'play → played (regular)' },
        ],
        practice: [
          { prompt: '"They ___ to Paris last year."', choices: ['go', 'went', 'have gone', 'are going'], correctIndex: 1, explain: 'last year = อดีต → went' },
        ],
      },
      {
        heading: 'Past Continuous (กำลัง...ในอดีต)',
        content: 'ใช้กับเหตุการณ์ที่<b>กำลังเกิดขึ้น</b>ในเวลาใดเวลาหนึ่งในอดีต หรือถูกขัดจังหวะ<br><br>โครงสร้าง: <b>S + was/were + V.ing</b><br><br>มักใช้คู่กับ Past Simple: <b>When</b> she called, I <b>was sleeping</b>.',
        examples: [
          { en: 'I <b>was watching</b> TV at 8 PM.', th: 'กำลังดูอยู่ตอน 2 ทุ่ม' },
          { en: 'When he arrived, we <b>were eating</b>.', th: 'กำลังกินตอนเขามา' },
        ],
      },
      {
        heading: 'Future Simple (จะ...)',
        content: 'ใช้กับเหตุการณ์ในอนาคต มี 2 รูปแบบ:<br>• <b>will + V.1</b> = จะ (ตัดสินใจตอนพูด, สัญญา, คาดการณ์)<br>• <b>is/am/are + going to + V.1</b> = จะ (วางแผนไว้ก่อน, มีหลักฐาน)<br><br>คำบอก: tomorrow, next week/month/year, in 2025, soon',
        examples: [
          { en: 'I <b>will</b> help you.', th: 'ตัดสินใจตอนพูด' },
          { en: 'She <b>is going to</b> travel next month.', th: 'วางแผนไว้แล้ว' },
          { en: 'Look at those clouds! It <b>is going to</b> rain.', th: 'มีหลักฐาน' },
        ],
        practice: [
          { prompt: '"Tomorrow I ___ my friend."', choices: ['meet', 'met', 'will meet', 'am meeting'], correctIndex: 2, explain: 'tomorrow = อนาคต → will + V.1' },
        ],
      },
    ],
    quiz: [
      { question: '"She ___ to work every day."', choices: ['go', 'goes', 'going', 'went'], correctIndex: 1, explain: 'Present Simple + She → goes' },
      { question: '"I ___ TV now."', choices: ['watch', 'watches', 'am watching', 'watched'], correctIndex: 2, explain: 'Present Continuous: am + V.ing' },
      { question: '"They ___ to Paris last year."', choices: ['go', 'went', 'have gone', 'are going'], correctIndex: 1, explain: 'last year = อดีต → went' },
      { question: '"I ___ already ___ my homework."', choices: ['have / finish', 'have / finished', 'has / finished', 'am / finishing'], correctIndex: 1, explain: 'Present Perfect: have + V.3' },
      ...
      { question: '"She ___ to Japan twice." (ประสบการณ์)', choices: ['goes', 'went', 'has been', 'is going'], correctIndex: 2, explain: 'ประสบการณ์ → Present Perfect' },
      { question: '"Water ___ at 100°C." (ความจริงเสมอ)', choices: ['boil', 'boils', 'boiled', 'is boiling'], correctIndex: 1, explain: 'ความจริงเสมอ → Present Simple' },
    ],
  },
  {
